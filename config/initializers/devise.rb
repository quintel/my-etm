...
Devise.setup do |config|
  ...
  # ==> Turbo configuration
  # Turbo only acts on a form response when it is a 422 or a 303 redirect; Devise's pre-Turbo
  # defaults (200 and 302) leave the page untouched with no feedback.
