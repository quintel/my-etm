...
Doorkeeper.configure do
  ...
  # resource_owner_authenticator do
  #   current_user || redirect_to('/auth/login') # Redirect to the Identity login path
  # end
  # resource_owner_authenticator do
...
Doorkeeper::JWT.configure do
  # The keypair used to sign the JWT
  secret_key ENV['JWT_SIGNING_KEY']
  # OpenSSL::PKey::RSA.new(Base64.decode64(ENV['JWT_SIGNING_KEY']))

  # Configuration of the JWT payload
  token_payload do |opts|
    {
      iss: 'myetm-idp',
      sub: opts[:resource_owner_id], # typically the user ID
      aud: opts[:client_id],
