namespace :data do
  ...
  task import: :environment do
    ...
    # Update these to match the location where you put the data
    backup_dir = "for_myetm"
    model_dump = "#{backup_dir}/model-2024-12-18.sql.xz"
    engine_dump = "#{backup_dir}/engine-2024-12-18.sql.xz"
